<template lang="html">
    <div class="main-wrapper page-container">
        <div class="zcy-row">
            <div class="aside-container zcy-col-xs-24 zcy-col-sm-24 zcy-col-md-6 zcy-col-lg-4">
                <v-menu mode="inline">
...
<style lang="less">
    ...
    .aside-container .zcy-menu-item a, .aside-container .zcy-menu-submenu-title span, .aside-container > .zcy-menu-item {
        font-size: 14px;
